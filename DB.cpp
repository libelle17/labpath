...
void dhcl::virtinitopt()
{
	...
	opn<<new optcl(/*pname*/"cmpwd",/*pptr*/&cmpwd,/*part*/ppwd,T_cmpwd_k,T_cmpwd_l,/*TxBp*/&Txd,/*Txi*/T_aendert_das_MySQL_MariaDB_Passwort_und_beendet_danach,/*wi*/1,/*Txi2*/-1,/*rottxt*/nix,/*wert*/-1,/*woher*/1,Txd[T_Aendert_das_Passwort_fuer_MySQL_MariaDB],/*obno*/1);
